...
const TagBadge = ({ children, text, active = false, href = '/' }: IProps) => {
  return (
    <Link href={href} className="body-medium mb-2 flex items-center justify-between text-dark-500 dark:text-light-700">
      <p
