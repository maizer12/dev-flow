...
const Sidebar = () => {
  ...
  return (
    <aside className="background-light900_dark200 light-border flex h-screen flex-col border-r px-3 pb-3.5 pt-36 shadow-light-300 dark:border-none dark:shadow-none sm:px-6 sm:pb-7 lg:w-[266px]">
